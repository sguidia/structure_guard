...
class PartTypesControllerTest < ActionController::TestCase
  ...
  test "should create part_type" do
    assert_difference('PartType.count') do
      post :create, part_type: { description: @part_type.description, image: @part_type.image, material_id: @part_type.material_id, name: @part_type.name, nestable: @part_type.nestable, version: @part_type.version }
    end
  ...
  test "should update part_type" do
    patch :update, id: @part_type, part_type: { description: @part_type.description, image: @part_type.image, material_id: @part_type.material_id, name: @part_type.name, nestable: @part_type.nestable, version: @part_type.version }
    assert_redirected_to part_type_path(assigns(:part_type))
  end
