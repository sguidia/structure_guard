...
(function() {
  ...
  ready = function() {
    ...
    allow_height = function() {
      ...
      return $door_height.children('option[value=8]').attr("selected", "selected");
    };
    zero_inset = function() {
      $door_inset.children('option').attr("selected", false);
      $door_inset.children('option[value="0"]').attr("selected", true).attr("disabled", false);
      return $door_inset.children(':not(:selected)').attr("disabled", "disabled");
    };
    full_door = function() {
      full_panel();
...
(function() {
  ...
  ready = function() {
    return $("input[type=submit].btn").each(function() {
      return $(this).click(function() {
        var loading_text, reg_form, validate_form;
        ...
        if (loading_text) {
          ...
          if (validate_form && validate_form.valid() === true) {
            $(this).addClass("disabled");
            return $(this).val(loading_text);
          }
        }
      });
    });
